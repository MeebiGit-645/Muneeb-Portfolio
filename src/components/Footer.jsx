...
export default function Footer({ data }) {
  ...
  const firstName = data?.profile?.name?. split(" ")[0] || "Muneeb";
  ...
  const stats = [
    { icon: Code, label: "Projects Completed", value: "15+", color: "from-dark-800 to-dark-700" },
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                {
                  icon: Linkedin,
                  href: data?.profile?.linkedin || "https://www.linkedin.com/in/muneeb-arif-5bbb66374",
                  label: "LinkedIn",
