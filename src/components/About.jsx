          ...
          >
            ...
            <p className="text-lg leading-relaxed mb-6">
              ...
              <span className="text-gray-700">
                who builds scalable, end-to-end web applications with{" "}
              </span>
              <span className="font-semibold text-dark-700">React</span>
              <span className="text-gray-700">, </span>
              <span className="font-semibold text-dark-700">Next.js</span>
              <span className="text-gray-700">, </span>
              <span className="font-semibold text-dark-700">Node.js</span>
              <span className="text-gray-700"> and </span>
              <span className="font-semibold text-dark-700">PostgreSQL/MongoDB</span>
              <span className="text-gray-700">
                . Comfortable working with{" "}
              </span>
              <span className="font-semibold text-dark-700">Supabase</span>
              <span className="text-gray-700">, modern </span>
              <span className="font-semibold text-dark-700">ORMs</span>
              <span className="text-gray-700"> (Sequelize, Prisma), and clean </span>
              <span className="font-semibold text-dark-700">MVC architecture</span>
              <span className="text-gray-700">
                . Experienced in designing{" "}
              </span>
              <span className="font-semibold text-dark-600">secure REST APIs</span>
              <span className="text-gray-700">, </span>
              <span className="font-semibold text-dark-600">
                optimizing backend performance
              </span>
              <span className="text-gray-700">
                , and deploying production-ready systems with{" "}
              </span>
              <span className="font-semibold text-dark-600">Docker</span>
              <span className="text-gray-700">
                . Beyond the web, I work across{" "}
              </span>
              <span className="font-semibold text-dark-700">AI</span>
              <span className="text-gray-700"> and </span>
              <span className="font-semibold text-dark-700">Computer Vision</span>
              <span className="text-gray-700">
                {" "}
              ...
              <span className="text-gray-700">
                {" "}
                solutions that turn complex problems into reliable products.{" "}
              </span>
            </p>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                {
                  icon:  Mail,
                  text: data?.profile?.email || "muneebarif645@gmail.com",
                  gradient: "from-dark-600 to-dark-500",
                  href: `mailto:${data?.profile?.email || "muneebarif645@gmail.com"}`,
                },
                {
                  icon: Phone,
                  text: phoneText,
            ...
            <div className="flex items-center gap-4">
              {[
                {
                  icon: Github,
                  href: data?.profile?.github || "https://github.com/muneeb-codehub",
                ...
                },
                {
                  ...
                  href: 
                    ...
                    "https://www.linkedin.com/in/muneeb-arif-5bbb66374",
                  gradient:  "from-dark-700 to-dark-600",
              ...
              <div className="relative p-1 bg-gradient-to-br from-dark-800 via-dark-600 to-dark-800 rounded-3xl">
                ...
                <div className="bg-white p-3 rounded-3xl">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border-4 border-dark-800 shadow-2xl">
                    {/* Main image */}
                    <img
                      src={data?.profile?.profileImage || "/assets/Muneeb.png"}
                      alt={data?.profile?.name || "Muneeb Arif"}
